            ...
            <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
              ...
              <div class="px-4 flex-none">
                <div class="" style="width: 90px; height: 90px">
                  <img src="{{ $carts->product()->exists() && $carts->product->galleries->first() ? Storage::url($carts->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='}}" alt="chair-1" class="object-cover rounded-xl w-full h-full" />
                </div>
              </div>
                ...
                >
                  <div class="">
                    <h6 class="font-semibold text-lg">IDR {{ number_format($carts->product->price) }}</h6>
                  </div>
                </div>
                <div class="px-4 w-2/12">
                  <div class="text-center">
